 ...
 */
@WebServlet("/InfoMultiOfficeModifyServlet")
public class InfoMultiOfficeModifyServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("WEB-INF/jsp/InfoMultiOfficeModify.jsp").forward(request, response);
