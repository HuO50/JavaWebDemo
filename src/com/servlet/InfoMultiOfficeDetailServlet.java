...
@WebServlet("/InfoMultiOfficeDetailServlet")
public class InfoMultiOfficeDetailServlet extends HttpServlet {
...
//		rule.toString();
		...
		request.getRequestDispatcher("WEB-INF/jsp/InfoMultiOfficeDetail.jsp").forward(request, response);
	}
