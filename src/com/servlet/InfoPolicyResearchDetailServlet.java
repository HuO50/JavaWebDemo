...
@WebServlet("/InfoPolicyResearchDetailServlet")
public class InfoPolicyResearchDetailServlet extends HttpServlet {
...
//		rule.toString();
		...
		request.getRequestDispatcher("WEB-INF/jsp/InfoPolicyResearchDetail.jsp").forward(request, response);
	}
