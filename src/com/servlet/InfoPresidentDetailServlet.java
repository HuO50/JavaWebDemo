...
@WebServlet("/InfoPresidentDetailServlet")
public class InfoPresidentDetailServlet extends HttpServlet {
...
//		rule.toString();
		...
		request.getRequestDispatcher("WEB-INF/jsp/InfoPresidentDetail.jsp").forward(request, response);
	}
