 ...
 */
@WebServlet("/InfoStandResearchModifyServlet")
public class InfoStandResearchModifyServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("WEB-INF/jsp/InfoStandResearchModify.jsp").forward(request, response);
