...
@WebServlet("/InfoAbstractInfoDetailServlet")
public class InfoAbstractInfoDetailServlet extends HttpServlet {
...
//		rule.toString();
		...
		request.getRequestDispatcher("WEB-INF/jsp/InfoAbstractInfoDetail.jsp").forward(request, response);
	}
