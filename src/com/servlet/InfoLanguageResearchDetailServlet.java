...
@WebServlet("/InfoLanguageResearchDetailServlet")
public class InfoLanguageResearchDetailServlet extends HttpServlet {
...
//		rule.toString();
		...
		request.getRequestDispatcher("WEB-INF/jsp/InfoLanguageResearchDetail.jsp").forward(request, response);
	}
