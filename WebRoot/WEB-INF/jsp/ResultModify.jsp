...
<body>
	<div style="float: left; height: 60%;">
		<form action="ResultModifyResult?newsid=${news.id}" method="post"
			...
			<div class="row cl">
				...
				<div class="formControls col-11" style="width: 80%">
					<input type="text" class="input-text" value="${news.title}"
				...
				<div>
					...
					<div class="formControls col-1" style="width: 10%;">
						<span class="select-box"> <select class="select" id="mark"
							name="mark">
								<option value="zdxm">重大项目</option>
								<option value="kxyj">科学研究</option>
								<option value="jpkc">精品课程</option>
						</select>
						</span>
					</div>
				</div>
