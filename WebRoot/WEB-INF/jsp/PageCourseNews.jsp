			...
			<div class="aside">
				<ul>
					...
					<a href="PageScienceResearchNews">
						<li class="btn " ng-click="changeContent($event,5,2)"
						ng-class="{'chooseContent':showContent == 3}"><span>科学研究</span></li>
					</a>
					<a href="PageCourseNews">
						<li class="btn chooseContent" ng-click="changeContent($event,5,3)"
						ng-class="{'chooseContent':showContent == 1}"><span>精品课程</span></li>
					</a>
				</ul>
			</div>
			<div class="section">
