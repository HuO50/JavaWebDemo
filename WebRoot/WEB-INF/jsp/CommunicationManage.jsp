	...
	<div class="pd-20">
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l">
				...
				onclick="article_add('发布新闻','CommunicationAdd')" href="javascript:;">
					...
					<c:forEach var="news" items="${newslist}">
						<tr class="text-c">
							...
							<td width="45%" style="text-align: left;">
                        		...
                        		onclick="layer_show('${news.title}','CommunicationDetail?newsid=${news.id}','800','800')">
                       			${news.title }</a>
                       		</td>
							...
							<td class="f-14 td-manage"><a style="text-decoration:none"
								class="ml-5"
								onClick="article_edit('修改新闻','CommunicationModify?newsid=${news.id}')"
								href="javascript:;" title="编辑"> <i class="fa fa-pencil"></i>
							</a> &nbsp;&nbsp;&nbsp;&nbsp; <a style="text-decoration:none"
								class="ml-5" onClick="article_del('删除新闻','CommunicationDelete?newsid=${news.id}')"
