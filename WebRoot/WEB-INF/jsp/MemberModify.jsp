...
<body>
	<div style="float: left; height: 60%;">
		<form action="MemberModifyResult?memberid=${member.id}" method="post"
			...
			<div class="row cl">
				...
				<div class="formControls col-11" style="width: 80%">
					<input type="text" class="input-text" value="${member.name}"
						placeholder="" id="name" name="name">
				</div>
			</div>
			<div class="row cl">
				<div>
					<label class="form-label col-1">所属：</label>
					<div class="formControls col-1" style="width: 10%;">
						<span class="select-box"> <select class="select" id="belong"
							name="belong">
								<option value="学术委员">学术委员</option>
								<option value="本院研究员">本院研究员</option>
			...
			<div class="row cl">
				...
				<div class="formControls col-11" style="width: 80%">
					<script id="content" name="resume" type="text/plain"
